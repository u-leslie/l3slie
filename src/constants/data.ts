...
export const experiences = [
  ...
  //   company: "Dunamis Organization",
  //   description:
  //     "Worked on various web development projects, creating responsive and user-friendly interfaces. Gained experience in both frontend and backend technologies.",
